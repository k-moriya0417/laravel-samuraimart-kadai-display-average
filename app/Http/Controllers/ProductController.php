...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('products.index',compact('products','category','major_category','categories','major_categories','total_count','keyword','reviews'));
    }
    ...
    public function show(Product $product)
    {
        ...
        $averageScore = $product->reviews()->avg('score');
        $aveStar = round($averageScore, 1);
        $dataStar =  round($averageScore * 2, 0) / 2;

        return view('products.show',compact('product','reviews','aveStar','dataStar'));
    }
